...
目录（位于 backend/data/noterx_workspace，沿用上游路径以保留已有本地数据）：
...
from app.paths import local_workspace_dir

logger = logging.getLogger("videorx.local_memory")

WORKSPACE_ROOT = str(local_workspace_dir())
...
MEMORY_MD_TEMPLATE = """# VideoRx 本地记忆（MEMORY）
