  ...
  return (
    <>
      <Box
        ...
        sx={{
          borderRadius: "8px",
          border: `1px dashed ${isDragging ? "#1E40AF" : error ? "#ef4444" : "#CBD5E1"}`,
          bgcolor: isDragging ? "#EFF6FF" : "#F8FAFC",
          backdropFilter: "blur(6px)",
          boxShadow: isDragging
            ? "0 0 0 3px rgba(30,64,175,0.12), inset 0 1px 0 rgba(255,255,255,0.9)"
          ...
          {hasFiles ? (
            ...
            >
              ...
              >
                  ...
                  return (
                    <Box
                      ...
                      sx={{
                        ...
                        "&:hover": { transform: "scale(1.02)", boxShadow: "0 4px 14px rgba(15,23,42,0.1)" },
                      }}
                    >
                ...
                {files.length < maxFiles && (
                  ...
                  >
                    <AddPhotoAlternateIcon sx={{ fontSize: 24, color: "#1E40AF" }} />
            ...
            >
              <Box sx={{
                ...
                <CloudUploadIcon sx={{ fontSize: compact ? 26 : 32, color: "#1E40AF" }} />
              </Box>
